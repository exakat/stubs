...
ResponseInterface $response) {}
    ...
    class Router implements \slim\interfaces\routerinterface {
        ...
        public function setContainer(ContainerInterface $container) {}
/** @var Route $route */
        public function map(/** @var Route $route */
$methods, /** @var Route $route */
$pattern, /** @var Route $route */
$handler) {}
...
namespace Slim\Exception {
    class ContainerValueNotFoundException extends \runtimeexception implements \psr\container\notfoundexceptioninterface {}

    class ContainerException extends \invalidargumentexception implements \psr\container\containerexceptioninterface {}
