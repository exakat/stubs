...
namespace Twig\Loader {
     ...
     * @author Fabien Potencier <fabien@symfony.com>
     */
    class FilesystemLoader implements \twig\loader\loaderinterface, \twig\loader\sourcecontextloaderinterface, \twig\loader\existsloaderinterface {
     ...
     * @author Fabien Potencier <fabien@symfony.com>
     */
    final class ArrayLoader implements \twig\loader\existsloaderinterface, \twig\loader\loaderinterface, \twig\loader\sourcecontextloaderinterface {
        private $templates;
     ...
     * @author Fabien Potencier <fabien@symfony.com>
     */
    final class ChainLoader implements \twig\loader\loaderinterface, \twig\loader\sourcecontextloaderinterface, \twig\loader\existsloaderinterface {
...
namespace Twig\Profiler {
     ...
     * @final since Twig 2.4.0
     */
    class Profile implements \serializable, \iteratoraggregate {
        const BLOCK = 'block';
        const ROOT = 'ROOT';
        const MACRO = 'macro';
