...
$constructorArgs) {}
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class Database implements \bolt\configuration\validation\pathresolverawareinterface, \bolt\configuration\validation\configawareinterface, \bolt\configuration\validation\validationinterface {
        /** @var PathResolver */
        private $pathResolver;
        /** @var Config */
        private $config;
...
PackageDescriptor $descriptor) {}
    ...
    use \bolt\extension\controllermounttrait, \bolt\extension\controllertrait, \bolt\extension\nuttrait, \bolt\extension\menutrait, \bolt\extension\translationtrait, \bolt\extension\twigtrait, \bolt\extension\configtrait, \bolt\extension\assettrait;
...
namespace Bolt\Legacy {
    ...
    use \bolt\storage\entity\contentroutetrait, \bolt\storage\entity\contenttypetrait, \bolt\storage\entity\contentrelationtrait, \bolt\storage\entity\contenttaxonomytrait, \bolt\storage\entity\contentvaluestrait, \bolt\storage\entity\contentsearchtrait;
...
namespace Bolt\Storage {
    ...
    use \bolt\storage\entity\contentsearchtrait, \bolt\storage\entity\contentroutetrait, \bolt\storage\entity\contentrelationtrait, \bolt\storage\entity\contentvaluestrait, \bolt\storage\entity\contenttaxonomytrait;
...
namespace Bolt\Storage\Database\Prefill {
    ...
    class RecordContentGenerator {
        ...
        public function __construct($contentTypeName, ApiClient $apiClient, ContentRepository $repository, FilesystemInterface $filesystem, array $taxConfig, ImmutableBag $defaultTitles) {}
...
$fieldObject) {}
    ...
    use \bolt\storage\mapping\contenttypetitletrait, \bolt\storage\entity\contentroutetrait, \bolt\storage\entity\contenttypetrait;
...
MenuEntry $otherEntry, /** @var Bag $contentType */
array $contentTypes) {}
    }
...
namespace Bolt\Twig {
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class ArrayAccessSecurityProxy implements \arrayaccess, \countable, \bolt\twig\securityproxyinterface, \iteratoraggregate {
