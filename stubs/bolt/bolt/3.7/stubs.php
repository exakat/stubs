...
/** @var \Bolt\Storage\Query\SearchQueryResultset $searchresults */
        private function search(/** @var \Bolt\Storage\Query\SearchQueryResultset $searchresults */
$query, /** @var \Bolt\Storage\Query\SearchQueryResultset $searchresults */
$withRecord = false) {}
...
namespace Bundle\Site {
    class BobEntity extends \bolt\storage\entity\content {
     ...
     */
    class CustomisationExtension extends \bolt\extension\simpleextension {}
...
$constructorArgs) {}
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class Database implements \bolt\configuration\validation\configawareinterface, \bolt\configuration\validation\pathresolverawareinterface, \bolt\configuration\validation\validationinterface {
        /** @var PathResolver */
        private $pathResolver;
        /** @var Config */
        private $config;
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class Cache implements \bolt\configuration\validation\pathresolverawareinterface, \bolt\configuration\validation\validationinterface {
        /** @var PathResolver */
        private $pathResolver;
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class Configuration implements \bolt\configuration\validation\configawareinterface, \bolt\configuration\validation\flashloggerawareinterface, \bolt\configuration\validation\validationinterface {
        /** @var Config */
        private $config;
        /** @var FlashLoggerInterface */
        private $flashLogger;
...
PackageDescriptor $descriptor) {}
    ...
    use \bolt\extension\menutrait, \bolt\extension\nuttrait, \bolt\extension\controllertrait, \bolt\extension\controllermounttrait, \bolt\extension\assettrait, \bolt\extension\configtrait, \bolt\extension\storagetrait, \bolt\extension\twigtrait, \bolt\extension\translationtrait;
...
Application $app) {}
    ...
    class ControllerServiceProvider implements \silex\serviceproviderinterface, \symfony\component\eventdispatcher\eventsubscriberinterface {
/** @deprecated Deprecated since 3.3, to be removed in 4.0. */
...
namespace Bolt\Legacy {
    ...
    use \bolt\storage\entity\contenttypetrait, \bolt\storage\entity\contentrelationtrait, \bolt\storage\entity\contentroutetrait, \bolt\storage\entity\contentsearchtrait, \bolt\storage\entity\contenttaxonomytrait, \bolt\storage\entity\contentvaluestrait;
...
$prefix = '$2a$', /** @var AbstractPassword $instance */
array $options = [ ]) {}
/** @var AbstractPassword $instance */
...
namespace Bolt\Storage {
    ...
    use \bolt\storage\entity\contentsearchtrait, \bolt\storage\entity\contentroutetrait, \bolt\storage\entity\contentrelationtrait, \bolt\storage\entity\contenttaxonomytrait, \bolt\storage\entity\contentvaluestrait;
...
$cmpOp) {}
    ...
    class TaxonomyRepository extends \bolt\storage\repository {
...
$fieldObject) {}
    ...
    use \bolt\storage\entity\contentusertrait, \bolt\storage\entity\contenturitrait, \bolt\storage\entity\contentroutetrait, \bolt\storage\entity\contenttypetrait, \bolt\storage\mapping\contenttypetitletrait;
...
array $contentType) {}
    ...
    use \bolt\storage\entity\entityarrayaccesstrait, \bolt\storage\entity\magicattributetrait, \bolt\storage\entity\entityserializetrait;
    ...
    use \bolt\storage\entity\appawaretrait, \bolt\storage\casetransformtrait{}
...
$target) {}
     ...
     * @author Ross Riley <riley.ross@gmail.com>
     */
    class HtmlType extends \bolt\storage\field\type\fieldtypebase implements \bolt\storage\field\sanitiser\sanitiserawareinterface, \bolt\storage\field\sanitiser\wysiwygawareinterface {
    use \bolt\storage\field\sanitiser\sanitiserawaretrait;
...
namespace Bolt\Storage\Query {
     ...
     * the ability to merge sets based on weighted scores.
     */
    class TaxonomyQueryResultset extends \bolt\storage\query\queryresultset {
        protected $em;
     ...
     *  @author Ross Riley <riley.ross@gmail.com>
     */
    class SelectQuery implements \bolt\storage\query\contentqueryinterface {
        /** @var QueryBuilder */
        protected $qb;
...
$value = null) {}
     ...
     *  @author Ross Riley <riley.ross@gmail.com>
     */
    class TaxonomyQuery implements \bolt\storage\query\queryinterface {
        /** @var QueryBuilder */
        protected $qb;
        /** @var array */
        protected $params;
     ...
     */
    interface QueryScopeInterface {
        function onQueryExecute(ContentQueryInterface $query) ;
    }
    ...
    interface ContentQueryInterface extends \bolt\storage\query\queryinterface {
        /**
...
/** @var Collection\Taxonomy $taxonomies */
        public function preview(/** @var Collection\Taxonomy $taxonomies */
Request $request, /** @var Collection\Taxonomy $taxonomies */
$contenttypeslug) {}
...
/** @var TaxonomyRepository $repo */
        public function taxonomy(/** @var TaxonomyRepository $repo */
Request $request, /** @var TaxonomyRepository $repo */
$taxonomytype, /** @var TaxonomyRepository $repo */
$slug) {}
...
/** @var \Bolt\Legacy\Storage $engine */
        private function populateItemFromRecord(/** @var \Bolt\Legacy\Storage $engine */
array $item, /** @var \Bolt\Legacy\Storage $engine */
$path) {}
    }
...
namespace Bolt\Twig\Runtime {
    ...
    class RoutingRuntime {
        ...
        public function __construct(Canonical $canonical, RequestStack $requestStack, $locale, UrlGeneratorInterface $urlGenerator, Users $users) {}
        /**
    ...
    class RecordRuntime {
        ...
        public function __construct(RequestStack $requestStack, PagerManager $pagerManager, DirectoryInterface $templatesDir, array $themeTemplateSelect, $useTwigGlobals, Query $query) {}
/** @var Request $request */
