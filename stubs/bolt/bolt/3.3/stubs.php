...
namespace Bolt\Configuration {
     ...
     */
    class ConfigurationValueProxy implements \symfony\component\eventdispatcher\eventsubscriberinterface, \arrayaccess {
        /** @var mixed|null */
        protected $data;
        /** @var Config */
        protected $config;
...
$constructorArgs) {}
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class Apache implements \bolt\configuration\validation\pathresolverawareinterface, \bolt\configuration\validation\validationinterface {
        /** @var PathResolver */
        private $pathResolver;
...
PackageDescriptor $descriptor) {}
    ...
    use \bolt\extension\assettrait, \bolt\extension\configtrait, \bolt\extension\controllertrait, \bolt\extension\controllermounttrait, \bolt\extension\menutrait, \bolt\extension\translationtrait, \bolt\extension\twigtrait, \bolt\extension\nuttrait;
...
/** @var Sandbox $sandbox */
        private function updateSandboxPolicy(/** @var Sandbox $sandbox */
Environment $twig) {}
...
$wrapperTemplate = 'widgetwrapper.twig') {}
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    interface WidgetAssetInterface extends \bolt\asset\assetinterface {
        /**
         * Get the wiget's key.
         *
         * @return string|null
...
namespace Bolt\Legacy {
    ...
    use \bolt\storage\entity\contentrelationtrait, \bolt\storage\entity\contentroutetrait, \bolt\storage\entity\contentsearchtrait, \bolt\storage\entity\contenttaxonomytrait, \bolt\storage\entity\contentvaluestrait;
...
$fieldObject) {}
    ...
    use \bolt\storage\entity\contentroutetrait, \bolt\storage\mapping\contenttypetitletrait;
...
array $contentType) {}
    ...
    use \bolt\storage\entity\entityserializetrait, \bolt\storage\entity\magicattributetrait, \bolt\storage\entity\entityarrayaccesstrait;
...
$entity) {}
     ...
     * @author Ross Riley <riley.ross@gmail.com>
     */
    abstract class FieldTypeBase implements \bolt\storage\field\fieldinterface, \bolt\storage\field\type\fieldtypeinterface {
    use \bolt\storage\casetransformtrait;
...
ContentType $contentType) {}
    ...
    class Save {
        ...
        public function __construct(EntityManager $em, Config $config, Users $users, LoggerInterface $loggerChange, LoggerInterface $loggerSystem, FlashLoggerInterface $loggerFlash, UrlGeneratorInterface $urlGenerator, Slugify $slugify = null) {}
...
/** @var \Symfony\Component\Form\Form $form */
        public function first(/** @var \Symfony\Component\Form\Form $form */
Request $request) {}
...
/** @var \Symfony\Component\HttpFoundation\RedirectResponse $response */
        private function firstPost(/** @var \Symfony\Component\HttpFoundation\RedirectResponse $response */
Request $request, /** @var \Symfony\Component\HttpFoundation\RedirectResponse $response */
Form $form) {}
...
namespace Bolt\Twig {
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class ArrayAccessSecurityProxy implements \iteratoraggregate, \bolt\twig\securityproxyinterface, \arrayaccess, \countable {
     ...
     */
    class SecurityPolicy implements \twig_sandbox_securitypolicyinterface {
        /** @var array */
        private $allowedTags;
        /** @var array */
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    abstract class TwigEnvironmentWrapper extends \twig_environment {
        protected $env;
...
Token $token) {}
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class RuntimeLoader implements \twig_runtimeloaderinterface {
        /** @var Container */
        private $container;
        /** @var array */
        private $mapping;
...
namespace Bolt\Twig\Extension {
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class AdminExtension extends \twig_extension {
        /**
         * {@inheritdoc}
         */
        public function getFunctions() {}
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class DumpExtension extends \twig_extension {
        public function getFunctions() {}
        public function getTokenParsers() {}
        public function getName() {}
    }
     ...
     * @internal
     */
    class ArrayExtension extends \twig_extension {
        private $orderOn;
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class RecordExtension extends \twig_extension {
        /**
         * {@inheritdoc}
         */
        public function getFunctions() {}
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class HtmlExtension extends \twig_extension {
        /**
         * {@inheritdoc}
         */
        public function getFunctions() {}
     ...
     */
    class BoltExtension extends \twig_extension implements \twig_extension_globalsinterface {
        /** @var EntityManagerInterface */
        private $em;
        /** @var Config */
        private $config;
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class UtilsExtension extends \twig_extension {
        /**
         * {@inheritdoc}
         */
        public function getFunctions() {}
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class TextExtension extends \twig_extension {
        /**
         * {@inheritdoc}
         */
        public function getFunctions() {}
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class RoutingExtension extends \twig_extension {
        /**
         * {@inheritdoc}
         */
        public function getFunctions() {}
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class WidgetExtension extends \twig_extension {
        /**
         * {@inheritdoc}
         */
        public function getFunctions() {}
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class UserExtension extends \twig_extension {
        /**
         * {@inheritdoc}
         */
        public function getFunctions() {}
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class ImageExtension extends \twig_extension {
        /**
         * {@inheritdoc}
         */
        public function getFunctions() {}
...
/** @var Bag $v */
        private static function getValues(/** @var Bag $v */
array $values) {}
    }
...
Entity\Users $user) {}
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class SystemLoggerListener implements \psr\log\loggerawareinterface, \symfony\component\eventdispatcher\eventsubscriberinterface {
...
StorageEvent $event) {}
    ...
    use \bolt\request\profilerawaretrait;
        ...
        public function __construct(\Twig_Environment $twig, $rootPath, DirectoryInterface $saveDir, SlugifyInterface $slugifer, $debug, Config $config, Users $users, SessionInterface $session, RequestStack $requestStack) {}
...
namespace Bolt\Session {
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class IniBag extends \bolt\session\optionsbag {
        /** @var string|null */
        private $extension;
        /** @var string|null */
        private $prefix;
...
namespace Bolt\Session\Handler {
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class FileHandler extends \bolt\session\handler\abstracthandler implements \bolt\session\handler\lazywritehandlerinterface {
        /** @var integer */
        protected $depth;
        /** @var integer */
        protected $mode;
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class DoctrineCacheHandler extends \bolt\session\handler\abstracthandler {
        /** @var Cache */
        protected $cache;
        /** @var int */
        protected $ttl;
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class FilesystemHandler extends \bolt\session\handler\abstracthandler {
        /** @var DirectoryInterface */
        protected $directory;
...
$maxlifetime) {}
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class PsrSimpleCacheHandler extends \bolt\session\handler\abstracthandler {
        /** @var CacheInterface */
        protected $cache;
        /** @var int */
        protected $ttl;
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class PsrCacheHandler extends \bolt\session\handler\abstracthandler {
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class MemcachedHandler extends \symfony\component\httpfoundation\session\storage\handler\memcachedsessionhandler implements \bolt\session\handler\lazywritehandlerinterface {
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class RedisHandler extends \bolt\session\handler\abstracthandler implements \bolt\session\handler\lazywritehandlerinterface {
        /** @var Redis|Predis */
        protected $redis;
        /** @var int */
        protected $ttl;
...
namespace Bolt\Session\Handler\Factory {
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class PredisFactory extends \bolt\session\handler\factory\abstractfactory {
        /**
         * Constructor.
         */
        public function __construct() {}
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class MemcachedFactory extends \bolt\session\handler\factory\abstractfactory {
        /** @var ParameterBag */
        protected $ini;
        /** @var string */
        protected $class;
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class RedisFactory extends \bolt\session\handler\factory\abstractfactory {
        /** @var string */
        protected $class;
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class MemcacheFactory extends \bolt\session\handler\factory\abstractfactory {
        /** @var string */
        protected $class;
