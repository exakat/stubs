...
array $values = [ ]) {}
    ...
    class Canonical implements \symfony\component\eventdispatcher\eventsubscriberinterface {
        ...
        public function __construct(RequestStack $requestStack, RequestContext $requestContext, UrlGeneratorInterface $urlGenerator, $override = null) {}
        /**
...
$themePath, /** @deprecated Deprecated since 3.0, to be removed in 4.0. (config.yml was the old filename) */
array $generalConfig) {}
        /**
...
/** @var PathInterface $filename */
        protected function parseSqliteOptions(/** @var PathInterface $filename */
array $config) {}
...
/** @var \Twig_Environment $env */
        public function hasTemplate(/** @var \Twig_Environment $env */
$template) {}
/** @var \Bolt\Asset\QueueInterface $queue */
        public function postProcess(/** @var \Bolt\Asset\QueueInterface $queue */
Request $request, /** @var \Bolt\Asset\QueueInterface $queue */
Response $response) {}
        /**
...
namespace Bolt\Configuration {
     ...
     * @deprecated Deprecated since 3.1, to be removed in 4.0.
     */
    class LowlevelChecks implements \bolt\configuration\validation\validatorinterface {
        public $config;
...
namespace Bolt\Configuration\Validation {
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class Validator extends \bolt\configuration\lowlevelchecks implements \bolt\configuration\validation\validatorinterface {
        ...
        public function __construct(Controller\Exception $exceptionController, Config $config, ResourceManager $resourceManager, FlashLoggerInterface $flashLogger) {}
        public function add($checkName, $className, $prepend = false) {}
        public function has($checkName) {}
        public function remove($checkName) {}
        public function check($checkName) {}
...
$constructorArgs) {}
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class Database implements \bolt\configuration\validation\configawareinterface, \bolt\configuration\validation\resourcemanagerawareinterface, \bolt\configuration\validation\validationinterface {
        /** @var ResourceManager */
        private $resourceManager;
        /** @var Config */
        private $config;
...
/** @var Controller\Exception $exceptionController */
        public function check(/** @var Controller\Exception $exceptionController */
ExceptionControllerInterface $exceptionController) {}
        /**
         * {@inheritdoc}
         */
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class Cache implements \bolt\configuration\validation\validationinterface, \bolt\configuration\validation\resourcemanagerawareinterface {
        /** @var ResourceManager */
        private $resourceManager;
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class Apache implements \bolt\configuration\validation\resourcemanagerawareinterface, \bolt\configuration\validation\validationinterface {
        /** @var ResourceManager */
        private $resourceManager;

/** @var LowlevelChecks $verifier */
        public function check(/** @var LowlevelChecks $verifier */
ExceptionControllerInterface $exceptionController) {}
        /**
         * {@inheritdoc}
         */
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class Configuration implements \bolt\configuration\validation\validationinterface, \bolt\configuration\validation\flashloggerawareinterface, \bolt\configuration\validation\configawareinterface {
        /** @var Config */
        private $config;
        /** @var FlashLoggerInterface */
        private $flashLogger;
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class MagicQuotes implements \bolt\configuration\validation\validationinterface {
        public function check(ExceptionControllerInterface $exceptionController) {}
        /**
         * {@inheritdoc}
         */
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class SafeMode implements \bolt\configuration\validation\validationinterface {
        public function check(ExceptionControllerInterface $exceptionController) {}
        /**
         * {@inheritdoc}
         */
    ...
    interface ValidationInterface {
        function check(ExceptionControllerInterface $exceptionController) ;
        /**
    ...
    interface ResourceManagerAwareInterface {
        function setResourceManager(ResourceManager $resourceManager) ;
    }
...
/** @var Content $entity */
        private function getEntityValues(/** @var Content $entity */
$queryString, /** @var Content $entity */
$limit, /** @var Content $entity */
$filter, /** @var Content $entity */
$key, /** @var Content $entity */
$orderBy = null) {}
    }
...
PackageDescriptor $descriptor) {}
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    abstract class SimpleExtension extends \bolt\extension\abstractextension implements \silex\serviceproviderinterface, \symfony\component\eventdispatcher\eventsubscriberinterface {
    use \bolt\extension\nuttrait, \bolt\extension\twigtrait, \bolt\extension\translationtrait, \bolt\extension\configtrait, \bolt\extension\controllertrait, \bolt\extension\controllermounttrait, \bolt\extension\menutrait, \bolt\extension\assettrait;
...
/** @var YamlFile $distFile */
        private function copyDistFile(/** @var YamlFile $distFile */
YamlFile $file) {}
        /** @return string */
        abstract public function getName() ;
        /** @return string */
...
namespace Bolt\Logger {
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class FlashLogger implements \bolt\logger\flashloggerinterface, \bolt\logger\flashbagattachableinterface {
        /** @var array $flash */
        protected $flashes;
...
/** @var \Bolt\Legacy\Content $content */
        protected function write(/** @var \Bolt\Legacy\Content $content */
array $record) {}
...
namespace Bolt\Asset {
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class BoltVersionStrategy extends \symfony\component\asset\versionstrategy\staticversionstrategy {
        /** @var FilesystemInterface */
        protected $filesystem;
        /** @var string */
        protected $baseSalt;
...
namespace Bolt\Asset\Snippet {
    ...
    class Queue implements \bolt\asset\queueinterface {
        ...
        public function __construct(Injector $injector, CacheProvider $cache, Config $config, ResourceManager $resources) {}
...
/** @var \Bolt\Storage\Repository\UsersRepository $repoUsers */
        public function __construct(/** @var \Bolt\Storage\Repository\UsersRepository $repoUsers */
Application $app) {}
...
/** @var Token\Token $sessionAuth */
        protected function checkSessionKeys(/** @var Token\Token $sessionAuth */
...
array $composerOverrides, /** @var Local $adapter */
$setDefaults = true) {}
        /**
...
/** @var Uri $uri */
        protected function parseConnections(/** @var Uri $uri */
$options, /** @var Uri $uri */
$defaultHost, /** @var Uri $uri */
$defaultPort, /** @var Uri $uri */
$defaultScheme = 'tcp') {}
    }
...
namespace Bolt\Legacy {
    ...
    use \bolt\storage\entity\contentrelationtrait, \bolt\storage\entity\contentroutetrait, \bolt\storage\entity\contentvaluestrait, \bolt\storage\entity\contentsearchtrait, \bolt\storage\entity\contenttaxonomytrait;
...
namespace Bolt\Filesystem\Plugin {
    class Authorized extends \bolt\filesystem\plugin\adapterplugin {
     ...
     * @deprecated Deprecated since 3.0, to be removed in 4.0.
     */
    class ThumbnailUrl extends \bolt\filesystem\plugin\adapterplugin {
        public function getMethod() {}
        public function getLocalThumb($path, $width, $height, $type) {}
    }

    abstract class AdapterPlugin implements \bolt\filesystem\plugininterface {
        /** @var FilesystemInterface */
        protected $filesystem;
        /** @var string */
        protected $namespace;
    ...
    class PublicUrl extends \bolt\filesystem\plugin\adapterplugin {
        public function getMethod() {}
...
namespace Bolt\Storage {
    ...
    use \bolt\storage\entity\contenttaxonomytrait, \bolt\storage\entity\contentvaluestrait, \bolt\storage\entity\contentroutetrait, \bolt\storage\entity\contentsearchtrait, \bolt\storage\entity\contentrelationtrait;
...
Entity\Content $entity) {}
     ...
     * @author Ross Riley <riley.ross@gmail.com>
     */
    class LazyCollection extends \doctrine\common\collections\abstractlazycollection {
...
namespace Bolt\Storage\Entity {
    ...
    use \bolt\storage\mapping\contenttypetitletrait, \bolt\storage\entity\contentroutetrait;
...
array $contentType) {}
    ...
    use \bolt\storage\entity\entityserializetrait, \bolt\storage\entity\entityarrayaccesstrait, \bolt\storage\entity\magicattributetrait;
...
namespace Bolt\Storage\Field\Type {
     ...
     * @author Ross Riley <riley.ross@gmail.com>
     */
    class TaxonomyType extends \bolt\storage\field\type\fieldtypebase {
        public function query(QueryInterface $query, ClassMetadata $metadata) {}
        public function load(QueryBuilder $query, ClassMetadata $metadata) {}
        public function hydrate($data, $entity) {}
        public function persist(QuerySet $queries, $entity) {}
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class RelationType extends \bolt\storage\field\type\fieldtypebase {
        public function query(QueryInterface $query, ClassMetadata $metadata) {}
        public function load(QueryBuilder $query, ClassMetadata $metadata) {}
        public function hydrate($data, $entity) {}
        public function persist(QuerySet $queries, $entity) {}
     ...
     * @author Ross Riley <riley.ross@gmail.com>
     */
    class TextType extends \bolt\storage\field\type\fieldtypebase {
        public function persist(QuerySet $queries, $entity) {}
        /**
         * {@inheritdoc}
         */
...
ContentType $contentType) {}
    ...
    class Save {
        ...
        public function __construct(EntityManager $em, Config $config, Users $users, LoggerInterface $loggerChange, LoggerInterface $loggerSystem, FlashLoggerInterface $loggerFlash, UrlGeneratorInterface $urlGenerator) {}
...
namespace Bolt\Storage\Migration {
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class Import extends \bolt\storage\migration\abstractmigration {
        /** @var array $data */
        protected $data;
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class Export extends \bolt\storage\migration\abstractmigration {
        /** @var array */
...
namespace Bolt\Storage\Migration\Input {
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class JsonFile implements \bolt\storage\migration\input\inputfileinterface {
        /** @var Import $import */
        private $import;
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class YamlFile implements \bolt\storage\migration\input\inputfileinterface {
        /** @var Import $import */
        private $import;
        /** @var \SplFileInfo $file */
        private $file;
    ...
    interface InputFileInterface {
        function __construct(Import $import, \SplFileInfo $file) ;
        /**
         * Read an import file.
         *
         * @return string
...
namespace Bolt\Storage\Migration\Output {
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class JsonFile implements \bolt\storage\migration\output\outputfileinterface {
        /** @var Export $export */
        private $export;
        /** @var \SplFileInfo $file */
        private $file;
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class YamlFile implements \bolt\storage\migration\output\outputfileinterface {
        /** @var Export $export */
        private $export;
        /** @var \SplFileInfo $file */
        private $file;
    ...
    interface OutputFileInterface {
        function __construct(Export $export, \SplFileInfo $file) ;
        function __destruct() ;
        function addRecord(array $data, $last) ;
    }
...
$contentid = null) {}
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class Exception extends \bolt\controller\base implements \bolt\controller\exceptioncontrollerinterface {
        protected function addRoutes(ControllerCollection $c) {}
...
array $contenttypes = null) {}
    ...
    interface ExceptionControllerInterface {
        function systemCheck($type, $messages = [ ], $context = [ ]) ;
    }
...
/** @var \Symfony\Component\Form\FormView|\Symfony\Component\Form\FormView[] $formView */
        public function edit(/** @var \Symfony\Component\Form\FormView|\Symfony\Component\Form\FormView[] $formView */
Request $request, /** @var \Symfony\Component\Form\FormView|\Symfony\Component\Form\FormView[] $formView */
$id) {}
/** @var \Symfony\Component\Form\Form */
        public function first(/** @var \Symfony\Component\Form\Form */
Request $request) {}
        public function modify($action, $id) {}
/** @var \Symfony\Component\Form\Form */
        public function profile(/** @var \Symfony\Component\Form\Form */
Request $request) {}
        /**
...
/** @var \Sirius\Upload\Result\Collection|\Sirius\Upload\Result\File $result */
        private function handleUploadFiles(/** @var \Sirius\Upload\Result\Collection|\Sirius\Upload\Result\File $result */
Request $request, /** @var \Sirius\Upload\Result\Collection|\Sirius\Upload\Result\File $result */
$namespace, /** @var \Sirius\Upload\Result\Collection|\Sirius\Upload\Result\File $result */
$files = null) {}
...
namespace Bolt\Routing {
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class UrlGeneratorFragmentWrapper implements \symfony\component\routing\generator\urlgeneratorinterface, \symfony\component\routing\generator\configurablerequirementsinterface {
        /** @var UrlGeneratorInterface */
        protected $wrapped;
...
namespace Bolt\Twig {
    class SetcontentNode extends \twig_node {
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class DynamicExtension extends \twig_extension {
        /** @var string */
        protected $name;
        /** @var SimpleFunction[] */
        protected $functions;
    ...
    class SetcontentTokenParser extends \twig_tokenparser {
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class DumpExtension extends \symfony\bridge\twig\extension\dumpextension {
        /** @var ClonerInterface */
        private $cloner;
     ...
     */
    class TwigExtension extends \twig_extension implements \twig_extension_globalsinterface {
        /** @var \Silex\Application */
        private $app;
        /** @var boolean */
        private $safe;
     ...
     */
    class SwitchNode extends \twig_node {
    ...
    class SwitchTokenParser extends \twig_tokenparser {
/** @var Twig_Token $v */
        public function parse(/** @var Twig_Token $v */
Twig_Token $token) {}
...
/** @var \Bolt\Menu\Menu $menu */
        public function menu(/** @var \Bolt\Menu\Menu $menu */
\Twig_Environment $env, /** @var \Bolt\Menu\Menu $menu */
$identifier = '', /** @var \Bolt\Menu\Menu $menu */
$template = '_sub_menu.twig', /** @var \Bolt\Menu\Menu $menu */
$params = [ ], /** @var \Bolt\Menu\Menu $menu */
$safe) {}
        public function shy($str) {}
        public function twig($snippet, $extravars = [ ]) {}
    }
...
namespace Bolt\Nut {
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class NutApplication extends \symfony\component\console\application {
        /**
...
/** @var \Symfony\Component\Console\Helper\QuestionHelper $helper */
        private function checkContinue(/** @var \Symfony\Component\Console\Helper\QuestionHelper $helper */
InputInterface $input, /** @var \Symfony\Component\Console\Helper\QuestionHelper $helper */
OutputInterface $output) {}
    }
    ...
    class UserResetPassword extends \bolt\nut\basecommand {
        ...
        protected function configure() {}
/** @var \Symfony\Component\Console\Helper\QuestionHelper $helper */
        protected function execute(/** @var \Symfony\Component\Console\Helper\QuestionHelper $helper */
InputInterface $input, /** @var \Symfony\Component\Console\Helper\QuestionHelper $helper */
OutputInterface $output) {}
    }
...
/** @var \Bolt\Storage\Repository\AuthtokenRepository $repo */
        private function deleteAuthtokens(/** @var \Bolt\Storage\Repository\AuthtokenRepository $repo */
Entity\Users $user) {}
...
Entity\Users $user) {}
    ...
    use \bolt\request\profilerawaretrait;
        ...
        public function __construct(EntityManagerInterface $em, EventProcessor\TimedRecord $timedRecord, Schema\SchemaManagerInterface $schemaManager, UrlGeneratorInterface $urlGenerator, FlashLoggerInterface $loggerFlash, PasswordFactory $passwordFactory, $hashStrength) {}
...
StorageEvent $event) {}
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class ExceptionListener implements \symfony\component\eventdispatcher\eventsubscriberinterface, \psr\log\loggerawareinterface {
    use \bolt\request\profilerawaretrait, \psr\log\loggerawaretrait;
...
/** @deprecated Deprecated since 3.0, to be removed in 4.0. */
        private function setGlobals(/** @deprecated Deprecated since 3.0, to be removed in 4.0. */
$safe) {}
    }
...
namespace Bolt\Session {
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class SessionStorage implements \symfony\component\httpfoundation\session\storage\sessionstorageinterface {
        /** @var string */
        protected $id;
        /** @var string */
        protected $name;
        ...
        public function __construct(OptionsBag $options, HandlerInterface $handler, GeneratorInterface $generator, SerializerInterface $serializer, LoggerInterface $logger = null, MetadataBag $metadataBag = null) {}
        /**
         * {@inheritdoc}
         */
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class OptionsBag extends \symfony\component\httpfoundation\parameterbag implements \arrayaccess {
        public function offsetExists($offset) {}
        public function offsetGet($offset) {}
        public function offsetSet($offset, $value) {}
        public function offsetUnset($offset) {}
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class SessionListener implements \symfony\component\eventdispatcher\eventsubscriberinterface {
        /** @var SessionInterface */
        protected $session;
        /** @var OptionsBag */
        protected $options;
...
namespace Bolt\Session\Handler {
     ...
     * @author Gawain Lynch <gawain.lynch@gmail.com>
     */
    class FileHandler implements \bolt\session\handler\lazywritehandlerinterface, \sessionhandlerinterface {
        /** @var integer */
        protected $depth;
        /** @var integer */
        protected $mode;
...
/** @var $file FileInterface */
        public function gc(/** @var $file FileInterface */
$maxlifetime) {}
        public function open($savePath, $sessionName) {}
        /**
         * {@inheritdoc}
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class MemcacheHandler extends \symfony\component\httpfoundation\session\storage\handler\memcachesessionhandler {
        /**
         * {@inheritdoc}
         *
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class RedisHandler implements \sessionhandlerinterface, \bolt\session\handler\lazywritehandlerinterface {
        /** @var Redis|Predis */
        protected $redis;
        /** @var int */
        protected $ttl;
    ...
    interface LazyWriteHandlerInterface {
        function updateTimestamp($sessionId, $data) ;
    }

}

namespace Bolt\Session\Serializer {
    class NativeSerializer implements \bolt\session\serializer\serializerinterface {
...
namespace Bolt\Session\Generator {
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class NativeGenerator implements \bolt\session\generator\generatorinterface {
        /** @var int */
        private $length;
     ...
     * @author Carson Full <carsonfull@gmail.com>
     */
    class RandomGenerator implements \bolt\session\generator\generatorinterface {
        /** @var Generator */
        protected $generator;
        /** @var integer */
        protected $length;
